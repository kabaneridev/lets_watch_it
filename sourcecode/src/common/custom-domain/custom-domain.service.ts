...
export class CustomDomainService {
    ...
    public index(params: {userId?: number, query?: string} = {}): PaginatedBackendResponse<CustomDomain> {
    ...
    public update(id, params: {host: string}): BackendResponse<{ domain: CustomDomain }> {
